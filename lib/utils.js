...
module.exports.locker = function() {
  ...
  function getRelease(origCb, cb, key) {
    return function(release) {
      var released = false;
      cb(function() {
        // prevent code calling release multiple times from invoking callback again
        if (!released) {
          released = true;
          release();
          if (origCb) {
  ...
  Locker.prototype.readLock = function(key, origCb, cb) {
    return this.rwlock.readLock(key, getRelease(origCb, cb));
  }

  Locker.prototype.writeLock = function(key, origCb, cb) {
    return this.rwlock.writeLock(key, getRelease(origCb, cb))
  }
